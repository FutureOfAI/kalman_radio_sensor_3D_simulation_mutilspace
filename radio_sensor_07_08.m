% Program name: radio_sensor_07_08.m
...
mag_E_0 = [Mag*cos(Angle_I)*cos(Angle_D) Mag*cos(Angle_I)*sin(Angle_D) Mag*sin(Angle_I)]; % N W DOWN
mag_E = (cz(-90*d2r)*cx(180*d2r)*mag_E_0')'; % N E UP
%mag_E = mag_E_0;
% ---------------------------------
r1 = [1 0 0];
r2 = [0 1 0];
...
% ===========================================================
    ...
    if ((time(k) <= 0.25*T)||((time(k)<=0.75*T)&&(time(k)>=0.5*T))),
% =========================================================
...
n2 = k-1;
plot63;
[(bgx_h(n2) - wbxm(n2)) (bgy_h(n2) - wbym(n2)) (bgz_h(n2) - wbzm(n2))]*r2d,
%plot58;