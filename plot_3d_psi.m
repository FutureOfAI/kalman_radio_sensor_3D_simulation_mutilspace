...
data = load('_3d_5mpsi_10.mat');
psi10 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_20.mat');
psi20 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_30.mat');
psi30 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_40.mat');
psi40 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_50.mat');
psi50 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_60.mat');
psi60 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_70.mat');
psi70 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_80.mat');
psi80 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_90.mat');
psi90 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_100.mat');
psi100 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_110.mat');
psi110 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_120.mat');
psi120 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_130.mat');
psi130 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_140.mat');
psi140 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_150.mat');
psi150 = abs(data.LS_delta_P);
data = load('_3d_5mpsi_160.mat');
